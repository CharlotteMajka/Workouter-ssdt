pipeline {
	...
	stage("Build DB") {
		...
		sh "sqlpackage /Action:Publish /TargetDatabaseName:Workouter /SourceFile:db/Workouter-SSDT/bin/Debug/Workouter-SSDT.dacpac /TargetPassword:HelloW0rld /TargetUser:sa /TargetServerName:devops.setgo.dk,22000"    
            }
        }
    }
}
